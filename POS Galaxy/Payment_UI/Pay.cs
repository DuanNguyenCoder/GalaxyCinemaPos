    ...
    public partial class Pay : Form
    {
       ...
       public int idHoaDon;
        ...
        private void payment(int typeOfpay)
        {
            ...
            invoice.InsertQuery(DateTime.Now, null, 7, 0, decimal.Parse(Total), null, null, null, typeOfpay, null);
            ...
            foreach (var item in Form1._form1.bill_panel.Controls)
            {
                ...
                if (item is ticket_Item)
                {
                    ...
                    {
                     orderFilm.Insert((int)ticketItem.Tag, ticketItem.voucher, ticketItem.seatLabel.Text, ticketItem.TypeTicket);

                    }
                    else
                    {
                       orderFilm.Insert((int)ticketItem.Tag, null , ticketItem.seatLabel.Text, ticketItem.TypeTicket);
                    }
